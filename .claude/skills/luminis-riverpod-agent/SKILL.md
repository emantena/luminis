...
description: Especialista em Riverpod do Luminis. Use quando Claude precisar implementar, revisar ou alterar estado, injecao de dependencia, providers, repositories mockados/API, controllers/view models ou testes com Riverpod 3.x em frontend/luminis_app.
---
